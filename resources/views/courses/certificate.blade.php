...
<div class="row justify-content-center mb-3"><div class="col-5"><div style="border-top:2px solid #1e6b3a;padding-top:.6rem"><div style="font-weight:700;font-size:.88rem;color:#1e6b3a">{{ $cert->issued_at->isoFormat('D [de] MMMM [de] Y') }}</div><div style="font-size:.72rem;color:#94a3b8">Fecha de emisión</div></div></div><div class="col-5"><div style="border-top:2px solid #1e6b3a;padding-top:.6rem"><div style="font-weight:700;font-size:.88rem;color:#1e6b3a">Director(a) CARDER</div><div style="font-size:.72rem;color:#94a3b8">Firma autorizada</div></div></div></div>
